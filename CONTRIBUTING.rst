...
When `reporting a bug <https://github.com/python-mario/python-mario/issues>`_ please include:
...
The best way to send feedback is to file an issue at https://github.com/python-mario/python-mario/issues.
...
1. Fork `python-mario <https://github.com/python-mario/python-mario>`_
   (look for the "Fork" button).
2. Clone your fork locally::

    git clone git@github.com:your_name_here/python-mario.git
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/python-mario/python-mario/pull_requests>`_ for each change you add in the pull request.
